 <link rel="stylesheet" type="text/css" href="/static/css/pollution.css" media="all" />
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1>Pollution</h1>
          <br>
          <h2>Voici la section information. Ici nous vous proposons
          des connaissances sur la pollution à travers différentes sections.
          La météo ? le vent ? le traffic routier et la pollution?
          Tout y est.</h2>
        </div>
  ...
  <div class="container">
     <p>*Clique sur une des images pour voir le texte associé.</p>
     <br>
     <center><h1>La météo et Pollution</h1></center>
      <br><br><br><br>
      <div class="row">
         <div class='col-lg-6' id="soleil">
          <input type="image" src ="/static/img/soleil.png" style='width:250px; height:190px;' onclick="meteo()">
         </div>
        <div class='col-lg-6' id='soleil_texte'>
          <br><br><br><br>
     ...
     <div class="row">
      <div class='col-lg-6' id="vent" >
        <input type="image" src ="/static/img/vent.jpg" onclick="vent()"> 
      </div>
      <div class='col-lg-6' id='vent_text'>
        <br><br><br><br>
        <h2>Le vent ?</h2>
      </div>
    ...
    <br><br><br><br>
     ...
     <div class="row">
      <div class='col-lg-6' id="saison">
        <input type="image" src ="/static/img/saison.jpg"  style='width:250px' onclick="saison()"> 
      </div>
      <div class='col-lg-6' id='saison_text'>
        <br><br><br><br>
        <h2>Les saisons ?</h2>
      </div>
    </div>
  ...
  <!-- About Section -->
  <section class="page-section bg-dark text-white">
    <center><h1>Les activités Humaines et Pollution</h1></center>
    <div class="container">
      <br><br><br><br><br>
  
      <div class="row">
         <div class='col-lg-6' id="soleil">
          <input type="image" src ="/static/img/trafic.jpg" onclick="trafic()"> 
         </div>
        <div class='col-lg-6' id='trafic_text'>
          <br><br><br><br>
          <h2>Le traffique routier ?</h2>
        </div>
      </div><br><br><br>
      ...
      <div class="row">
         <div class='col-lg-6' id="indu">
          &nbsp;&nbsp;
          <input type="image" src ="/static/img/indus.jpg" onclick="indus()">  
         </div>
        <div class='col-lg-6' id='indus_text'>
          <br><br><br><br>
          <h2>Les poles industrielles ?</h2>
        </div>
      </div><br><br><br>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 text-center">
            <div class="mt-5">
              ...
              <p class="text-muted mb-0">Notre prédiction est un outils qui, par différentes conditions donne une approximation
              par moyenne du taux de pollution dans la ville.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 text-center">
            <div class="mt-5">
             <a href='/polution/donnée'>
              ...
              <br>
              <p class="text-muted mb-0">La pollution se déplace par le vent. Et si nous la suivions.</p>
            </div>
          </div>
  ...
  <script type="text/javascript" src="/static/js/info_pollu.js"></script>
