...
<head>
  ...
  <link href="/static/css/creativepolu.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="/">My_Polution</a>
        ...
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
           <a href = "/photo/mes_images">
            ...
            <a class="nav-link js-scroll-trigger" href="/polution/charger">Charger une image</a>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href = "/photo/coupe">
              ...
              <a class="nav-link js-scroll-trigger" href="/photo/coupe">Info trafique</a>
            </a>
          </li>
          ...
          <li class="nav-item">
           <a href = "/photo/habits">
            ...
            <a class="nav-link js-scroll-trigger" href="/photo/habits">Tous sur la pollution</a>
            </a>
          </li>
          ...
          <li class="nav-item">
           <a href = "/photo/habits">
            <img src="/static/img/portfolio/icone/vetements.png" id="im3">
            <a class="nav-link js-scroll-trigger" href="/photo/habits">Météo France</a>
            </a>
          </li>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <br><br><br><br><br>
          <h1 class="text-uppercase text-white font-weight-bold">Bienvenu !</h1>
          <br>
          <style>#h{font:Serif; color:white;}</style> 
          <h2 id="h">My Pollution est un site qui va test d'analyser le taux de pollution dans l'air, et ptetre savoir
          si y'a du charbon, ou du nitrate fin des particules visibles mais egalement en correllant la meteo et les depart en vacs</h2>
          <h3>Basé sur l'expérience de Chenbin Liu, Francis Tsow, Yi Zou, Nongjian Tao sauf que nous y'a une machine a pluie
          et que c iench heuresement n'ont pas mis leur code attention les calcules peuvent etre faux mais ca chai pas s'il faut le laisser</h3>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
           ...
           <img src = "/static/img/portfolio/icone/telecharger.png"/ id="im6">
            <h3 class="h4 mb-2">Télécharger une image</h3>
            <p class="text-muted mb-0">Télécharge une image et va essayer des coupes de cheveux et des vetements !!</p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
           ...
           <img src = "/static/img/portfolio/icone/photo.png"/ id="im4">
            <h3 class="h4 mb-2">Prendre une photo !   </h3>
            <br>
            <p class="text-muted mb-0">Va faire la star ! et va essayer une coupe de cheveux !</p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
           ...
           <img src = "/static/img/portfolio/icone/vetements.png"/ id="im5">
            <h3 class="h4 mb-2">Essaie des vetements !</h3>
            <p class="text-muted mb-0">Selon la tendance du moment va essayer des vetements
            notre algorith fais par un genie chinois te propose les meilleurs couleurs </p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
           ...
           <img src = "/static/img/portfolio/icone/magasin.png"/ id="im7">
            <h3 class="h4 mb-2">e-commerce</h3>
            <br>
            <p class="text-muted mb-0">thune Thune THUNEEEE</p>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="mt-0">Qui sommes nous!</h2>
          <hr class="divider my-4">
          <p class="text-muted mb-5">Ecolo ? Chercheur ? ou bien Babacool ?</p>
          <p class="text-muted mb-5">Joins nous ;)</p>
        </div>
      </div>
      <div class="row">
