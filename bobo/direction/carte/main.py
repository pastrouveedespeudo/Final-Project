"""I cant use reverse call localisation
So i must intermediate views with direction functions
with a main... (runner() is the problem)"""
        ...
        while True:
            ...
            for i in liste:
                ...
                if new_lat != '' and new_long != '':
                    ...
                    nouvelle_position = long_lat(new_lat,
                                                 new_long,
                                                 vent,
                                                 position_vent)

                else:
                    nouvelle_position = long_lat(lat,
                                                 long,
                                                 vent,
                                                 position_vent)
