...
from static.bobo.coupe_analysis import recup2
from static.bobo.mode_analyse import recup

from .tendance_site.mode_w_data import haut_bas
...
def database_mode(request):
    ...
    for i in theliste1:
        ...
        try:
            liste11.append((str(theliste1[c]), str(theliste1[c+1]), int(str(c) + str(c))))
            c+=2
        except:
            pass


    a = haut_bas()#mode_w_data
    b = recup2()#coupe_analysis
    c = liste11
